<div class="max-w-6xl mx-auto flex gap-6 grid grid-cols-1 lg:grid-cols-7 lg:gap-6">
    ...
    {{-- Quiz Form --}}
    <div class="flex-1 lg:col-span-6 col-span-1 bg-white shadow-lg rounded-xl p-5 lg:p-10 bg-cover bg-center overflow-auto no-scrollbar" style="background-image: url('{{ $bgImage }}');">
        {{-- QUIZ HEADER --}}
