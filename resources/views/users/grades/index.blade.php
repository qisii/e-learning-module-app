...
<div class="w-full p-4 lg:p-10 md:p-10 overflow-auto no-scrollbar" style="font-family: 'Poppins', sans-serif;">
    ...
    <div class="bg-white rounded-xl shadow-md p-6 text-[12px]">
        ...
        <div class="flex flex-col sm:flex-row w-full sm:items-center justify-end gap-3 lg:gap-4">
            <form action="{{ route('grades.pretest.search') }}" method="get" class="flex flex-col sm:flex-row w-full sm:items-center gap-3 lg:gap-4">
        ...
        <div class="overflow-x-auto mt-5">
            <table class="min-w-full border-collapse table-auto">
                ...
                <tbody class="text-gray-600">
                    ...
                    @else
                        <tr>
                            <td colspan="6" class="text-center p-3">No pretest results yet.</td>
                        </tr>
                    @endif
                </tbody>
            </table>
