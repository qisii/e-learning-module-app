...
@section('content')
    <div class="w-full flex flex-col lg:flex-row relative">
        ...
        <img src="{{ asset('assets/images/Star.png') }}" alt="Star" 
            class="block lg:hidden absolute top-[10%] left-[10%] md:w-[120px]  w-[60px] z-[-20]">
        <img src="{{ asset('assets/images/stair.png') }}" alt="Periwinkle" 
            class="block lg:hidden absolute top-[10%] left-[70%] md:left-[82%] w-[60px] z-[-20]">
        <img src="{{ asset('assets/images/Tube.png') }}" alt="Tube" 
            class="block lg:hidden absolute top-[70%] right-[10%] w-[80px] z-[-20]">
        <img src="{{ asset('assets/images/periwrinkle.png') }}" alt="Star" 
            class="block lg:hidden absolute top-[85%] right-[10%] w-[100px] z-[-20]">
        <img src="{{ asset('assets/images/Star.png') }}" alt="Periwinkle" 
            class="block lg:hidden absolute top-[95%] right-[50%] w-[50px] z-[-20]">
