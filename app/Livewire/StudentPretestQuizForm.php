...
class StudentPretestQuizForm extends Component
{
    use WithFileUploads;
    ...
    protected function store($score)
    {
        ...
        return redirect()->route('pre.quiz.score', ['quizAttemptId' => $quizAttempt->id]);
    }

    public function render()
    {
        return view('livewire.student-pretest-quiz-form');
    }
}


/*
array:2 [▼ // app\Livewire\StudentPretestQuizForm.php:69
  "total_questions" => 5
  "correct_answers" => 1
]
*/